...
-- Ensure form_settings table allows public read access
GRANT SELECT ON form_settings TO anon, authenticated;

CREATE POLICY IF NOT EXISTS "Allow public read" ON form_settings
  FOR SELECT TO anon, authenticated
  USING (true);